...
install_requires = [
    ...
    'httplib2>=0.9.2',
    'invenio-access>=1.0.0a11,<1.5.0',
    'invenio-accounts>=1.0.0b9,<1.3.0',
    'invenio-accounts-rest>=1.0.0a4,<1.1.0',
    'invenio-base>=1.0.0a14,<1.3.0',
    'invenio-celery>=1.0.0b1,<1.3.0',
    'invenio-config>=1.0.0b2,<=1.0.2',
    'invenio-db[postgresql,versioning]>=1.0.0b7,<1.1.0',
    'invenio-deposit>=1.0.0a8,<1.1.0',
    'invenio-files-rest>=1.0.0a21,<1.1.0',
    'invenio-mail>=1.0.0b1,<1.2.0',
    'invenio-marc21>=1.0.0a3',
    'invenio-oaiserver>=1.0.0a9,<1.2.0',
    'invenio-oauthclient>=1.0.0a13,<1.3.0',
    'invenio-oauth2server>=1.0.0a14,<1.2.0',
    'invenio-pidstore>=v1.0.0b1,<1.3.0',
    'invenio-pidrelations>=v1.0.0a4,<1.1.0',
    'invenio-query-parser>=0.6.0,<1.1.0',
    'invenio-records>=1.0.0b1,<1.4.0',
    'invenio-records-rest>=1.0.0a17,<1.8.0',
    'invenio-records-files>=1.0.0a9,<1.3.0',
    'invenio-rest[cors]>=1.0.0a10,<1.3.0',
    'invenio-search>=1.0.0a10,<1.4.0',
    'invenio-stats>=1.0.0a8',
    'invenio-logging>=1.0.0a3,<1.4.0',
    'invenio-indexer>=1.0.0,<1.4.0',
